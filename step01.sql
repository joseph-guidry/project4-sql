...
INSERT INTO players VALUES (0, 'Michael', 'Thomas', 1000, 13), 
						   (0, 'Drew', 'Brees', 1000, 09), 
					 	   (0, 'Mark', 'Ingram', 1000, 22), 
						   (0, 'Will', 'Lutz', 1000, 03);

/* Insert 4 Falcons Players */
INSERT INTO players VALUES (0, 'Matt', 'Ryan', 1001, 02), 
						   (0, 'Julio', 'Jones', 1001, 11),
						   (0, 'Tevin', 'Coleman', 1001, 26), 
						   (0, 'Matt', 'Bryant', 1001, 3);

/* Insert 4 Panthers Players */
INSERT INTO players VALUES (0, 'Cam', 'Newton', 1002, 01), 
						   (0, 'Devin', 'Funchess', 1002, 17), 
						   (0, 'Luke', 'Kuechly', 1002, 59), 
					  	   (0, 'Graham', 'Gano', 1002, 09);

/* Insert 4 Buccaneers Players */
INSERT INTO players VALUES (0, 'Jameis', 'Winston', 1003, 03), 
						   (0, 'Gerald', 'McCoy', 1003, 93),
						   (0, 'Doug', 'Martin', 1003, 22), 
						   (0, 'Patrick', 'Murphy', 1003, 07);

/* Insert 1 player that has NO team */

INSERT INTO players VALUES (0, 'Joseph', 'Guidry', NULL, NULL);


/* ADD Personal Info for Players */
/* PID, Age, Height(inches), Weight(lbs) */
INSERT INTO personal_info VALUES (01, 24, 76, 212), (02, 38, 72, 209), 
								 (03, 27, 69, 215), (04, 23, 73, 184), 
								 (05, 32, 76, 217), (06, 28, 75, 220), 
								 (07, 24, 73, 210), (08, 42, 69, 203), 
								 (09, 28, 77, 245), (10, 23, 76, 225), 
								 (11, 26, 75, 238), (12, 30, 74, 202), 
								 (13, 23, 76, 231), (14, 29, 76, 300),
								 (15, 28, 69, 223), (16, 26, 67, 182), 
								 (17, 30, 67, 165);

/* Insert the GameID, Date, HomeTeamID, and AwayTeamID */
...
/* Insert TeamID, GameID and Score, with Outcome */
INSERT INTO game_scores VALUES (1003, 01, 31, 24, 55, 'W'), 
						       (1001, 01, 24, 31, 55, 'L'), 
						       (1001, 02, 45, 32, 77, 'W'), 
						       (1000, 02, 32, 45, 77, 'L'),
						       (1002, 03, 33, 48, 81, 'L'), 
